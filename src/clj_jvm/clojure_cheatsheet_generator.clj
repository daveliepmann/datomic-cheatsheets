(ns clj-jvm.clojure-cheatsheet-generator
...
;; Documentation describing the shape of the value of cheatsheat-structure:
...
(def html-header-after-title "  <link rel=\"stylesheet\" href=\"cheatsheet_files/style.css\" type=\"text/css\" />
...
;;                   cmd prefix suffix (class whole-cmd) whole-cmd)
        ...
        cleaned-doc-str (when orig-doc-str (cleanup-doc-str-tooltip orig-doc-str))
        cleaned-doc-str (when cleaned-doc-str
                          (do
